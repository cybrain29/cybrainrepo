...
addon_id='plugin.fmovies.gallery'
...
BASEURL = 'https://fmovies.gallery/'
metaset = selfAddon.getSetting('enable_meta')
metaget = metahandlers.MetaData()

def Main_menu():
    addDir('[B][COLOR white]Most Watched[/COLOR][/B]',BASEURL + '/most-watched',5,ICON,FANART,'')
    addDir('[B][COLOR white]Movies[/COLOR][/B]',BASEURL + '/all-films',5,ICON,FANART,'')
    addDir('[B][COLOR white]Country[/COLOR][/B]',BASEURL + '/countries',5,ICON,FANART,'')
    addDir('[B][COLOR white]TV Shows[/COLOR][/B]',BASEURL + '/all-series',5,ICON,FANART,'')
    addDir('[B][COLOR white]Genres[/COLOR][/B]',BASEURL + '/genres',3,ICON,FANART,'')
    addDir('[B][COLOR white]Search[/COLOR][/B]',BASEURL + '/search/',6,ICON,FANART,'')
    setView('tvshows', 'List')

def Get_Genres():
    OPEN = Open_Url('https://fmovies.gallery/genres/')
